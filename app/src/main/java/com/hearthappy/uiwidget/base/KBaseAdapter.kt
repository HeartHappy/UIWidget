package com.hearthappy.uiwidget.base
 ...
 * @Describe 万用适配器
 */
abstract class KBaseAdapter<VB : ViewBinding, T>(var list: MutableList<T> = mutableListOf()) : RecyclerView.Adapter<KBaseAdapter<VB, T>.ViewHolder>() {
